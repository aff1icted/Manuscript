...
import { ADMIN_AUTHOR_ROUTE, ADMIN_BOOK_ROUTE, ADMIN_COVER_ROUTE, ADMIN_FORMAT_ROUTE, ADMIN_PAGE_ROUTE, ADMIN_PARTNER_ROUTE, ADMIN_ROUTE, ADMIN_SERIES_ROUTE, ADMIN_TAG_ROUTE } from "../utils/consts";
...
const NavAdmin = () => {
    return (
        <div className="admmenu">
            ...
            <li><Link to={ADMIN_PARTNER_ROUTE}>Партнеры</Link></li>        
